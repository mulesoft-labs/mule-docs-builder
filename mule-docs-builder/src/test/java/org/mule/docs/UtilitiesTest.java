...
public class UtilitiesTest {
    ...
    public void getConcatenatedFilepath_WithTwoDirectories_IsValid() {
        ...
        assertTrue(path.contentEquals(TestUtilities.getPathToMasterFolder() + "/cloudhub"));
    }
    ...
    public void getRandomAlphaNumericString_IsValid() {
        ...
        for (int i = 0; i < 10; i++) {
            for (int j = 0; j < 10; j++) {
                if (i != j) {
                    assertFalse(randomStrings.get(i).equals(randomStrings.get(j)));
                }
            }
    ...
    public void isActiveUrlInSection_WithValidUrl_ReturnsTrue() {
        ...
        boolean result = Utilities.isActiveUrlInSection(root, "cloudhub-administration", false);
        assertTrue(result);
    }
    ...
    public void validateIfActiveUrlIsInSection_ValidUrl_IsValid() {
        TocNode root = TestUtilities.getValidRootNode();
        Utilities.validateIfActiveUrlIsInSection(root, "cloudhub-administration");
        assertTrue(true);
    }
    ...
    public void validateIfActiveUrlIsInSection_WithValidRootUrl_IsValid() {
        TocNode root = TestUtilities.getValidRootNode();
        Utilities.validateIfActiveUrlIsInSection(root, "deploying-a-cloudhub-application");
        assertTrue(true);
    }
