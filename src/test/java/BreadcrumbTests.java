...
public class BreadcrumbTests {
    ...
    public void fromRootNode_WithValidRootNodeAndUrl_ReturnsObject() {
        Breadcrumb breadcrumb = Breadcrumb.fromRootNode(TestUtilities.getValidRootNode(), "cloudhub-at-a-glance.html");
    ...
    public void fromRootNode_WithInvalidRootNodeAndUrl_ThrowsException() {
        Breadcrumb.fromRootNode(TestUtilities.getInvalidRootNode(), "cloudhub-at-a-glance.html");
    }
    ...
    public void fromRootNode_WithValidRootNodeAndInvalidUrl_ThrowsException() {
        Breadcrumb.fromRootNode(TestUtilities.getValidRootNode(), "foo.html");
    }
}
