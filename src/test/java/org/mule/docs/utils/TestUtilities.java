...
public class TestUtilities {
    ...
    public static String getPathToMasterFolder() {
        return Utilities.getConcatPath( getTestResourcesPath(), "master-folder" );
    }

    public static TocNode getValidRootNode() {
        String tocPath = Utilities.getConcatPath( TestUtilities.getPathToMasterFolder(), "cloudhub", "toc.ad" );
    ...
    public static TocNode getInvalidRootNode() {
        String tocPath = Utilities.getConcatPath( TestUtilities.getTestResourcesPath(), "bad-files", "toc.ad" );
        SectionTableOfContents toc = SectionTableOfContents.fromAsciiDocFile(new File(tocPath));
        return toc.getRootTocNode();
    }
}
