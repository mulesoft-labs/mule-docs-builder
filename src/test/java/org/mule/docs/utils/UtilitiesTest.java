...
public class UtilitiesTest {
    ...
    public void validateAsciiDocFile_IsValidForAsciiDocExtension() {
        Utilities.validateAsciiDocFile(new File(Utilities.getConcatPath(
                TestUtilities.getPathToMasterFolder(), "cloudhub", "cloudhub.ad")));
        assertTrue(true);
    }
    ...
    public void validateAsciiDocFile_ThrowsExceptionForNonExistentFile() {
        Utilities.validateAsciiDocFile(new File(Utilities.getConcatPath(
                TestUtilities.getPathToMasterFolder(), "cloudhub", "blah")));
        assertTrue(true);
    }
    ...
    public void validateAsciiDocFile_ThrowsExceptionForBadExtension() {
        Utilities.validateAsciiDocFile(new File(Utilities.getConcatPath(
                TestUtilities.getPathToMasterFolder(), "_templates", "default.template")));
        assertTrue(true);
    }
    ...
    public void getConcatenatedFilepath_WithTwoDirectories_IsValid() {
        String path = Utilities.getConcatPath(TestUtilities.getPathToMasterFolder(), "cloudhub");
    ...
    public void getConcatenatedFilepath_WithTwoDirectoriesAndFilename_IsValid() {
        String path = Utilities.getConcatPath(TestUtilities.getPathToMasterFolder(), "cloudhub", "cloudhub.ad");
    ...
    public void getConcatenatedFilepath_WithDirectoryAndFilenameAndAnotherDirectory_IsValid() {
        String path = Utilities.getConcatPath(TestUtilities.getPathToMasterFolder(), "cloudhub", "cloudhub.ad", "cloudhub");
    ...
    public void validateCtorObjectsAreNotNull_WithNonNullParams_IsValid() {
        File file1 = new File(Utilities.getConcatPath(TestUtilities.getPathToMasterFolder(), "cloudhub", "cloudhub-faq.ad"));
        File file2 = new File(Utilities.getConcatPath(TestUtilities.getPathToMasterFolder(), "cloudhub", "cloudhub-at-a-glance.ad"));
    ...
    public void getOnlyContentDivFromHtml_WithValidHtml_ReturnsDesiredContent() {
        File file = new File(Utilities.getConcatPath(TestUtilities.getPathToMasterFolder(), "cloudhub", "cloudhub.ad"));
    ...
    public void getFileContentsFromFiles_SpecifiedExistingFilesContents_AreReturned() {
        ...
        String sampleFilePath = Utilities.getConcatPath(TestUtilities.getTestResourcesPath(), "text-files");
    ...
    public void getFileContentsFromFiles_FilesDoNotExist_ThrowsException() {
        String sampleFilePath1 = Utilities.getConcatPath(TestUtilities.getTestResourcesPath(), "text-files", "foo.txt");
        String sampleFilePath2 = Utilities.getConcatPath(TestUtilities.getTestResourcesPath(), "text-files", "bar.txt");
    ...
    public void getFileContentsFromFile_SpecifiedExistingFileContents_AreReturned() {
        ...
        String sampleFilePath = Utilities.getConcatPath(TestUtilities.getTestResourcesPath(), "text-files", "sample-1.txt");
    ...
    public void getFileContentsFromFile_FileDoesNotExist_ThrowsException() {
        String sampleFilePath = Utilities.getConcatPath(TestUtilities.getTestResourcesPath(), "text-files", "foo.txt");
    ...
    public void fileExists_WithValidFile_IsValid() {
        File file = new File(Utilities.getConcatPath(TestUtilities.getPathToMasterFolder(), "cloudhub", "deploying-a-cloudhub-application.ad"));
    ...
    public void fileExists_WithInvalidFile_ThrowsException() {
        File file = new File(Utilities.getConcatPath(TestUtilities.getPathToMasterFolder(), "foo"));
        Utilities.validateFileExists(file);
    }

    @Test
    public void validateIsDirectory_WithValidDirectory_IsValid() {
        File directory = new File(Utilities.getConcatPath(TestUtilities.getPathToMasterFolder()));
    ...
    public void validateIsDirectory_WithFileNotDirectory_ThrowsException() {
        File file = new File(Utilities.getConcatPath(TestUtilities.getPathToMasterFolder(), "cloudhub", "cloudhub-faq.ad"));
    ...
    public void validateDirectoryContainsAsciiDocFile_WithNoAsciiDocFiles_ThrowsException() {
        File file = new File(Utilities.getConcatPath(TestUtilities.getTestResourcesPath(), "text-files"));
        Utilities.validateDirectoryContainsAsciiDocFile(file);
    }
    ...
    public void directoryContainsVersions_WithInvalidDirectory_IsFalse() {
        File file = new File(Utilities.getConcatPath(TestUtilities.getPathToMasterFolder(), "anypoint-platform"));
        boolean result = Utilities.directoryContainsVersions(file);
        assertFalse(result);
    }
    ...
    public void validateMasterDirectory_WithEmptyMasterDirectory_ThrowsException() {
        Utilities.validateMasterDirectory(new File(Utilities.getConcatPath(TestUtilities.getTestResourcesPath(), "empty")));
    }

    @Test(expected = DocBuildException.class)
    public void validateMasterDirectory_WithOnlyTocInMasterDirectory_ThrowsException() {
        Utilities.validateMasterDirectory(new File(Utilities.getConcatPath(TestUtilities.getTestResourcesPath(), "bad-files")));
    }

    @Test
    public void validateTemplateFile_WithValidFile_IsValid() {
        Utilities.validateTemplateFile(new File(Utilities.getConcatPath(TestUtilities.getTestResourcesPath(), "master-folder", "_templates", "default.template")));
        assertTrue(true);
    }

    @Test(expected = DocBuildException.class)
    public void validateTemplateFile_WithInvalidFile_ThrowsException() {
        Utilities.validateTemplateFile(
                new File(Utilities.getConcatPath(TestUtilities.getTestResourcesPath(), "master-folder", "anypoint-platform", "cloudhub.ad")));
    }

    @Test
    public void makeTargetDirectory_SpecifiedNonExistentDirectoryPath_IsCreated() {
        String newFolderPath = Utilities.getConcatPath(TestUtilities.getTestResourcesPath(), "output", "test");
