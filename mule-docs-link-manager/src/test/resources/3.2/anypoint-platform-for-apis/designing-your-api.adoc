...
image:designing-your-api-1.png[image]
...
+
image:designing-your-api-2.png[image] +
...
+
image:designing-your-api-3.png[image]
+
[source,ruby]
----
#%RAML 0.8
...
+
image:designing-your-api-4.png[image] +
+
...
+
image:designing-your-api-5.png[image] +
...
image:designing-your-api-6.png[image]

image:designing-your-api-7.png[image]
...
* Examine a link:/documentation/display/current/APIkit+Tutorial#APIkitTutorial-MicroProcedures[tabular breakdown of an example API definition] used for the link:/anypoint-platform-for-apis/apikit-tutorial[APIkit tutorial].
